...
print*, 'Enter b between 2 and 12'
read*, b

open(unit=10, file='p1.dat')
open(unit=20, file='E1.dat')
open(unit=30, file='x1.dat')
...
do i=1,200000
	...
	E1(i+1)=(1/b)*x1(i+1)**b+0.5*p1(i+1)**2
enddo
...
do i=1,200000
	...
	E2(i+1)=(1/b)*x2(i+1)**b+0.5*p2(i+1)**2
enddo
...
do i=1,200000
	...
	E3(i+1)=(1/b)*x3(i+1)**b+0.5*p3(i+1)**2
